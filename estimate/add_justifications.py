...
def get_unit(description):
    ...
    if "sqft" in desc or "square foot" in desc or "per sf" in desc or "flooring" in desc:
        return "SQFT"
    elif "lf" in desc or "linear" in desc or "baseboard" in desc or "drywall removal up to" in desc:
        return "LF"
